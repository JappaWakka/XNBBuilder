...
namespace XNBBuilderLib
{
    public class XNBBuilder : BuildContent
    {
        ...
        public string[] PackageContent(string[] fileNames, string outputDirectory, 
            bool shouldLog, string rootDirectory, out bool buildStatus)
        {
            ...
            try
            {
                ...
                string xnaInstallFolder = 
                    Environment.ExpandEnvironmentVariables("%XNAGSv4%") 
            ...
            {
                Debug.WriteLine("[ex] BuildEngine Exception : " + ex.Message);
            }
            finally
            {
